...
use app\widgets\HistoryList\items\ChangeTypeItem\ChangeTypeItemWidget;
use yii\base\Event;

class CustomerChangeTypeEvent extends Event implements HistoryEventInterface
{
    /** @var History $model */
    private $model;
    ...
    {
        return ChangeTypeItemWidget::class;
    }
}
